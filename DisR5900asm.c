...
void P_ADDI(char *buf)   { sprintf(buf, "addi\t%s, %s, 0x%04lX",   GPR_REG[DECODE_RT], GPR_REG[DECODE_RS], DECODE_IMMED);}
void P_ADDIU(char *buf)  { sprintf(buf, "addiu\t%s, %s, 0x%04lX",  GPR_REG[DECODE_RT], GPR_REG[DECODE_RS], DECODE_IMMED);}
void P_SLTI(char *buf)   { sprintf(buf, "slti\t%s, %s, 0x%04lX",   GPR_REG[DECODE_RT], GPR_REG[DECODE_RS], DECODE_IMMED); }
void P_SLTIU(char *buf)  { sprintf(buf, "sltiu\t%s, %s, 0x%04lX",  GPR_REG[DECODE_RT], GPR_REG[DECODE_RS], DECODE_IMMED); }
void P_ANDI(char *buf)   { sprintf(buf, "andi\t%s, %s, 0x%04lX",   GPR_REG[DECODE_RT], GPR_REG[DECODE_RS], DECODE_IMMED);}
void P_ORI(char *buf)    { sprintf(buf, "ori\t%s, %s, 0x%04lX",    GPR_REG[DECODE_RT], GPR_REG[DECODE_RS], DECODE_IMMED); }
void P_XORI(char *buf)   { sprintf(buf, "xori\t%s, %s, 0x%04lX",   GPR_REG[DECODE_RT], GPR_REG[DECODE_RS], DECODE_IMMED); }
void P_LUI(char *buf)    { sprintf(buf, "lui\t%s, 0x%04lX",        GPR_REG[DECODE_RT], DECODE_IMMED); }
...
void P_DADDI(char *buf)  { sprintf(buf, "daddi\t%s, %s, 0x%04lX",  GPR_REG[DECODE_RT], GPR_REG[DECODE_RS], DECODE_IMMED); }
void P_DADDIU(char *buf) { sprintf(buf, "daddiu\t%s, %s, 0x%04lX", GPR_REG[DECODE_RT], GPR_REG[DECODE_RS], DECODE_IMMED); }
void P_LDL(char *buf)    { sprintf(buf, "ldl\t%s, 0x%04lX(%s)",    GPR_REG[DECODE_RT], DECODE_IMMED, GPR_REG[DECODE_RS]); }
void P_LDR(char *buf)    { sprintf(buf, "ldr\t%s, 0x%04lX(%s)",    GPR_REG[DECODE_RT], DECODE_IMMED, GPR_REG[DECODE_RS]); }
void P_LB(char *buf)     { sprintf(buf, "lb\t%s, 0x%04lX(%s)",     GPR_REG[DECODE_RT], DECODE_IMMED, GPR_REG[DECODE_RS]); }
void P_LH(char *buf)     { sprintf(buf, "lh\t%s, 0x%04lX(%s)",     GPR_REG[DECODE_RT], DECODE_IMMED, GPR_REG[DECODE_RS]); }
void P_LWL(char *buf)    { sprintf(buf, "lwl\t%s, 0x%04lX(%s)",    GPR_REG[DECODE_RT], DECODE_IMMED, GPR_REG[DECODE_RS]); }
void P_LW(char *buf)     { sprintf(buf, "lw\t%s, 0x%04lX(%s)",     GPR_REG[DECODE_RT], DECODE_IMMED, GPR_REG[DECODE_RS]); }
void P_LBU(char *buf)    { sprintf(buf, "lbu\t%s, 0x%04lX(%s)",    GPR_REG[DECODE_RT], DECODE_IMMED, GPR_REG[DECODE_RS]); }
void P_LHU(char *buf)    { sprintf(buf, "lhu\t%s, 0x%04lX(%s)",    GPR_REG[DECODE_RT], DECODE_IMMED, GPR_REG[DECODE_RS]); }
void P_LWR(char *buf)    { sprintf(buf, "lwr\t%s, 0x%04lX(%s)",    GPR_REG[DECODE_RT], DECODE_IMMED, GPR_REG[DECODE_RS]); }
void P_LWU(char *buf)    { sprintf(buf, "lwu\t%s, 0x%04lX(%s)",    GPR_REG[DECODE_RT], DECODE_IMMED, GPR_REG[DECODE_RS]); }
void P_SB(char *buf)     { sprintf(buf, "sb\t%s, 0x%04lX(%s)",     GPR_REG[DECODE_RT], DECODE_IMMED, GPR_REG[DECODE_RS]); }
void P_SH(char *buf)     { sprintf(buf, "sh\t%s, 0x%04lX(%s)",     GPR_REG[DECODE_RT], DECODE_IMMED, GPR_REG[DECODE_RS]); }
void P_SWL(char *buf)    { sprintf(buf, "swl\t%s, 0x%04lX(%s)",    GPR_REG[DECODE_RT], DECODE_IMMED, GPR_REG[DECODE_RS]); }
void P_SW(char *buf)     { sprintf(buf, "sw\t%s, 0x%04lX(%s)",     GPR_REG[DECODE_RT], DECODE_IMMED, GPR_REG[DECODE_RS]); }
void P_SDL(char *buf)    { sprintf(buf, "sdl\t%s, 0x%04lX(%s)",    GPR_REG[DECODE_RT], DECODE_IMMED, GPR_REG[DECODE_RS]); }
void P_SDR(char *buf)    { sprintf(buf, "sdr\t%s, 0x%04lX(%s)",    GPR_REG[DECODE_RT], DECODE_IMMED, GPR_REG[DECODE_RS]); }
void P_SWR(char *buf)    { sprintf(buf, "swr\t%s, 0x%04lX(%s)",    GPR_REG[DECODE_RT], DECODE_IMMED, GPR_REG[DECODE_RS]); }
void P_LD(char *buf)     { sprintf(buf, "ld\t%s, 0x%04lX(%s)",     GPR_REG[DECODE_RT], DECODE_IMMED, GPR_REG[DECODE_RS]); }
void P_SD(char *buf)     { sprintf(buf, "sd\t%s, 0x%04lX(%s)",     GPR_REG[DECODE_RT], DECODE_IMMED, GPR_REG[DECODE_RS]); }
void P_LQ(char *buf)     { sprintf(buf, "lq\t%s, 0x%04lX(%s)",     GPR_REG[DECODE_RT], DECODE_IMMED, GPR_REG[DECODE_RS]); }
void P_SQ(char *buf)     { sprintf(buf, "sq\t%s, 0x%04lX(%s)",     GPR_REG[DECODE_RT], DECODE_IMMED, GPR_REG[DECODE_RS]); }
void P_SWC1(char *buf)   { sprintf(buf, "swc1\t%s, 0x%04lX(%s)",   COP1_REG_FP[DECODE_FT], DECODE_IMMED, GPR_REG[DECODE_RS]); }
void P_SQC2(char *buf)   { sprintf(buf, "sqc2\t%s, 0x%04lX(%s)",   COP2_REG_FP[DECODE_FT], DECODE_IMMED, GPR_REG[DECODE_RS]); }
void P_PREF(char *buf)   { strcpy(buf,  "pref ---");/*sprintf(buf, "PREF\t%s, 0x%04lX(%s)",   GPR_REG[DECODE_RT], DECODE_IMMED, GPR_REG[RS]); */}
void P_LWC1(char *buf)   { sprintf(buf, "lwc1\t%s, 0x%04lX(%s)",   COP1_REG_FP[DECODE_FT], DECODE_IMMED, GPR_REG[DECODE_RS]); }
void P_LQC2(char *buf)   { sprintf(buf, "lqc2\t%s, 0x%04lX(%s)",   COP2_REG_FP[DECODE_FT], DECODE_IMMED, GPR_REG[DECODE_RS]); }
//********************END OF STANDARD OPCODES*************************
...
void P_SLL(char *buf)
{
   if (cpuRegs.code == 0x00000000)
        ...
        sprintf(buf, "sll\t%s, %s, 0x%02lX", GPR_REG[DECODE_RD], GPR_REG[DECODE_RT], DECODE_SA);
}

void P_SRL(char *buf)    { sprintf(buf, "srl\t%s, %s, 0x%02lX", GPR_REG[DECODE_RD], GPR_REG[DECODE_RT], DECODE_SA); }
void P_SRA(char *buf)    { sprintf(buf, "sra\t%s, %s, 0x%02lX", GPR_REG[DECODE_RD], GPR_REG[DECODE_RT], DECODE_SA); }
...
void P_DSLL(char *buf)    { sprintf(buf, "dsll\t%s, %s, 0x%02lX",   GPR_REG[DECODE_RD], GPR_REG[DECODE_RT], DECODE_SA); }
void P_DSRL(char *buf)    { sprintf(buf, "dsrl\t%s, %s, 0x%02lX",   GPR_REG[DECODE_RD], GPR_REG[DECODE_RT], DECODE_SA); }
void P_DSRA(char *buf)    { sprintf(buf, "dsra\t%s, %s, 0x%02lX",   GPR_REG[DECODE_RD], GPR_REG[DECODE_RT], DECODE_SA); }
void P_DSLL32(char *buf)  { sprintf(buf, "dsll32\t%s, %s, 0x%02lX", GPR_REG[DECODE_RD], GPR_REG[DECODE_RT], DECODE_SA); }
void P_DSRL32(char *buf)  { sprintf(buf, "dsrl32\t%s, %s, 0x%02lX", GPR_REG[DECODE_RD], GPR_REG[DECODE_RT], DECODE_SA); }
void P_DSRA32(char *buf)  { sprintf(buf, "dsra32\t%s, %s, 0x%02lX", GPR_REG[DECODE_RD], GPR_REG[DECODE_RT], DECODE_SA); }
...
void P_TGEI(char *buf)    { sprintf(buf, "tgei\t%s, 0x%04lX", GPR_REG[DECODE_RS], DECODE_IMMED); }
void P_TGEIU(char *buf)   { sprintf(buf, "tgeiu\t%s,0x%04lX", GPR_REG[DECODE_RS], DECODE_IMMED); }
void P_TLTI(char *buf)    { sprintf(buf, "tlti\t%s, 0x%04lX", GPR_REG[DECODE_RS], DECODE_IMMED); }
void P_TLTIU(char *buf)   { sprintf(buf, "tltiu\t%s,0x%04lX", GPR_REG[DECODE_RS], DECODE_IMMED); }
void P_TEQI(char *buf)    { sprintf(buf, "teqi\t%s, 0x%04lX", GPR_REG[DECODE_RS], DECODE_IMMED); }
void P_TNEI(char *buf)    { sprintf(buf, "tnei\t%s, 0x%04lX", GPR_REG[DECODE_RS], DECODE_IMMED); }
...
void P_MTSAB(char *buf)   { sprintf(buf, "mtsab\t%s, 0x%04lX", GPR_REG[DECODE_RS], DECODE_IMMED);}
void P_MTSAH(char *buf)   { sprintf(buf, "mtsah\t%s, 0x%04lX", GPR_REG[DECODE_RS], DECODE_IMMED);}
...
void P_PSLLH(char *buf)   { sprintf(buf, "psllh   \t%s, %s, 0x%02lX",   GPR_REG[DECODE_RD], GPR_REG[DECODE_RT], DECODE_SA); }
void P_PSRLH(char *buf)   { sprintf(buf, "psrlh   \t%s, %s, 0x%02lX",   GPR_REG[DECODE_RD], GPR_REG[DECODE_RT], DECODE_SA);}
void P_PSRAH(char *buf)   { sprintf(buf, "psrah   \t%s, %s, 0x%02lX",   GPR_REG[DECODE_RD], GPR_REG[DECODE_RT], DECODE_SA);}
void P_PSLLW(char *buf)   { sprintf(buf,  "psllw   \t%s, %s, 0x%02lX",   GPR_REG[DECODE_RD], GPR_REG[DECODE_RT], DECODE_SA);}
void P_PSRLW(char *buf)   { sprintf(buf,  "psrlw   \t%s, %s, 0x%02lX",   GPR_REG[DECODE_RD], GPR_REG[DECODE_RT], DECODE_SA);}
void P_PSRAW(char *buf)   { sprintf(buf,  "psraw   \t%s, %s, 0x%02lX",   GPR_REG[DECODE_RD], GPR_REG[DECODE_RT], DECODE_SA);}
//***************************END OF SPECIAL OPCODES******************
//*************************MMI0 OPCODES************************

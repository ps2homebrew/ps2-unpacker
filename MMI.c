...
#define _PMAXW(n)                                                 \
    cpuRegs.GPR.r[_Rd_].UL[n] =                                   \
        (cpuRegs.GPR.r[_Rs_].SL[n] > cpuRegs.GPR.r[_Rt_].SL[n]) ? \
            cpuRegs.GPR.r[_Rs_].UL[n] :                           \
            cpuRegs.GPR.r[_Rt_].UL[n];
...
#define _PMAXH(n)                                                 \
    cpuRegs.GPR.r[_Rd_].US[n] =                                   \
        (cpuRegs.GPR.r[_Rs_].SS[n] > cpuRegs.GPR.r[_Rt_].SS[n]) ? \
            cpuRegs.GPR.r[_Rs_].US[n] :                           \
            cpuRegs.GPR.r[_Rt_].US[n];
...
#define _PADDSW(n)                                                             \
    ...
    } else if ((sTemp64 < 0x180000000) && (sTemp64 >= 0x100000000)) {          \
...
#define _PADDSH(n)                                                             \
    ...
    } else if ((sTemp32 < 0x18000) && (sTemp32 >= 0x10000)) {                  \
...
#define _PMINW(n)                                                 \
    cpuRegs.GPR.r[_Rd_].SL[n] =                                   \
        (cpuRegs.GPR.r[_Rs_].SL[n] < cpuRegs.GPR.r[_Rt_].SL[n]) ? \
            cpuRegs.GPR.r[_Rs_].SL[n] :                           \
            cpuRegs.GPR.r[_Rt_].SL[n];
...
void PSLLVW()
{
    ...
    cpuRegs.GPR.r[_Rd_].UD[0] = (s32)(cpuRegs.GPR.r[_Rt_].UL[0] << (cpuRegs.GPR.r[_Rs_].UL[0] & 0x1F));
    cpuRegs.GPR.r[_Rd_].UD[1] = (s32)(cpuRegs.GPR.r[_Rt_].UL[2] << (cpuRegs.GPR.r[_Rs_].UL[2] & 0x1F));
}
...
#define _PHMSBH(hlr, dd, n, rdd)                                                             \
    {                                                                                        \
        ...
        cpuRegs.hlr.UL[dd] = temp;                                                           \
        if (_Rd_)                                                                            \
            cpuRegs.GPR.r[_Rd_].UL[rdd] = temp;                                              \
    }
